...
module ActiveMerchant #:nodoc:
  module Billing #:nodoc:
    # This gateway uses the current Airwallex {Payment Intents API}[https://www.airwallex.com/docs/api#/Payment_Acceptance/Payment_Intents/Intro].
    class AirwallexPaymentIntentsGateway < AirwallexGateway
      ...
      def store(payment_method, options = {})
        ...
        if payment_method.is_a?(AirwallexPaymentToken) || payment_method.is_a?(ActiveMerchant::Billing::CreditCard)
